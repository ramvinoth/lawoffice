...
<div class="">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Tomorrow's Hearings</span>
                        <span class="info-box-number">{{count_data['tmrw_hearing']}}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
        ...
        <div class="row">
            ...
            <section class="col-lg-7 connectedSortable">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Upcoming Hearings</h3>
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div v-if="upcoming_hearing.length > 0" class="table-responsive h300px">
                            <table class="table no-margin">
                                <thead>
                                    <tr>
                                        <th>Case no.</th>
                                ...
                                <tbody>
                                    <tr v-for="(hearing, index) in upcoming_hearing">
                                        <td>{{hearing.case_no}}</td>
                                        <td>
                                            <div v-if="hearing.item !== ''">{{hearing.item}}</div>
                                            <div v-else>-</div>
                                        </td>
                                        <td>{{hearing.posted}}</td>
                                        <td>
                                            <div v-if="hearing.status !== ''">{{hearing.status}}</div>
                                            <div v-else>-</div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div v-else class="text-center h300px">
                            <div class="emptycont">
                                <i class="ion ion-ios-calendar-outline fs5em"></i>
                                <div>There are no upcoming hearings for next 15 days</div>
                            </div>
                        </div>
                        <!-- /.table-responsive -->
                    </div>
                    <!-- /.box-body -->
                    <div class="box-footer clearfix">
                        <router-link to="/create" class="btn btn-sm btn-info btn-flat pull-left hide">Add New Hearing</router-link>
                        <router-link to="/diary" class="btn btn-sm btn-default btn-flat pull-right">View All Hearings</router-link>
                    </div>
                    <!-- /.box-footer -->
                </div>
                <!-- /.box -->
    ...
    <mpopup>
        <viewcase :model="case_data"></viewcase>
    </mpopup>
</div>
</template>
...
<script>
    ...
    export default{
        ...
        mounted(){
            ...
            this.fetchData('api/dashboard','action=getupcominghearing','upcoming_hearing');
