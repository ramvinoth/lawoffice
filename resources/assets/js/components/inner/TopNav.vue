...
<header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-lg"><b>Law Ofiice</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img :src="getAuthUserData.avatar" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img :src="getAuthUserData.avatar" class="user-image" alt="User Image">
              <span class="hidden-xs">{{getAuthUserData.name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
